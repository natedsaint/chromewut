...
"use strict";var WutController=function(){};WutController.prototype={pad:function(e){return 10>e?"0"+e:e},selectAll:function(){var e=$("#link");e.focus(),e.select()},executeCopy:function(){var e=document.createElement("textarea"),t=$("#link");document.body.appendChild(e),e.value=t.html(),e.focus(),e.select(),document.execCommand("Copy"),e.remove(),$(".linkHolder").addClass("copied"),setTimeout(function(){$(".linkHolder").removeClass("copied")},2e3)},generateLink:function(){var e=this,t=$("#urlField").val()||$("#urlField").attr("placeholder"),n=$("#activationDateField").val(),r=$("#deactivationDateField").val(),o=$("#generateLink");return o.hasClass("disabled")?!1:(o.addClass("disabled").html("Generating..."),$.ajax({url:"http://wut.link/",type:"POST",dataType:"json",data:{url:t,activateDate:n,deactivateDate:r},success:function(t){t.errors?e.onGenerateLinkError(t.errors):e.onGenerateLinkSuccess(t),e.resetGenerateLinkButton()}}),void 0)},onGenerateLinkError:function(e){var t=[];if("object"==typeof e)for(var n in e)t=t.concat(e[n]);t.length&&(t.unshift("A link wasn't created because:<br>"),Message.show(t.join("<br>")))},onGenerateLinkSuccess:function(e){var t=$("#generateLink");$("#link").html(e.proxyUrl),$(".linkHolder").addClass("loaded"),t.removeClass("disabled").html("Create Link"),$("#copyAsap").is(":checked")&&this.executeCopy()},bindListeners:function(){chrome.tabs.query({active:!0,currentWindow:!0},function(e){$("#urlField").attr("placeholder",e[0].url)}),$("#generateLink").on("click",$.proxy(this.generateLink,this)),$("#link").on("click",this.selectAll),$("#copyButton").on("click",this.executeCopy)},resetGenerateLinkButton:function(){var e=$("#generateLink");e.removeClass("disabled").html("Create Link")}};var wut=new WutController;"undefined"!=typeof module&&void 0!==module.exports&&(module.exports=wut);
"use strict";var AlertController=function(){};AlertController.prototype={show:function(i){this.message.html(i),this.container.css("visibility","visible"),this.container.css("opacity",1)},hide:function(){this.container.css("visibility","hidden"),this.container.css("opacity",0)},bindListeners:function(){this.container=$(".alertContainer"),this.message=this.container.find(".message:first"),$("#ok").on("click",$.proxy(this.hide,this))}};var message=new AlertController;"undefined"!=typeof module&&void 0!==module.exports&&(module.exports=message);
"function"==typeof jQuery&&"function"==typeof wut.bindListeners&&!function(n,e){n(document).ready(function(){e.bindListeners()})}(jQuery,wut),"function"==typeof jQuery&&"function"==typeof wut.bindListeners&&!function(n,e){n(document).ready(function(){e.bindListeners()})}(jQuery,message);