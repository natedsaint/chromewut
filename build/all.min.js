...
"use strict";var WutController=function(e){var t=this;t.message=e};WutController.prototype={pad:function(e){return 10>e?"0"+e:e},selectAll:function(){var e=$("#link");return e.focus(),e.select(),e},executeCopy:function(){var e=document.createElement("textarea"),t=$("#link");return document.body.appendChild(e),e.value=t.html(),e.focus(),e.select(),document.execCommand("Copy"),e.remove(),$(".linkHolder").addClass("copied"),setTimeout(function(){$(".linkHolder").removeClass("copied")},2e3),t},generateLink:function(){var e=this,t=$("#urlField").val()||$("#urlField").attr("placeholder"),n=$("#activationDateField").val(),r=$("#deactivationDateField").val(),a=$("#generateLink");return a.hasClass("disabled")?!1:(a.addClass("disabled").html("Generating..."),$.ajax({url:"http://wut.link/",type:"POST",dataType:"json",data:{url:t,activateDate:n,deactivateDate:r},success:e.handleResponse.bind(e)}))},handleResponse:function(e){var t=this;return e.errors?t.onGenerateLinkError(e.errors):t.onGenerateLinkSuccess(e),t.resetGenerateLinkButton(),e},onGenerateLinkError:function(e){var t,n=this,r=[];if("object"==typeof e)for(t in e)e.hasOwnProperty(t)&&(r=r.concat(e[t]));return r.length&&void 0!==n.message&&(r.unshift("A link wasn't created because:<br>"),n.message.show(r.join("<br>"))),r},onGenerateLinkSuccess:function(e){var t=this,n=$("#generateLink");return $("#link").html(e.proxyUrl),$(".linkHolder").addClass("loaded"),n.removeClass("disabled").html("Create Link"),$("#copyAsap").is(":checked")&&t.executeCopy(),t},onTabQuery:function(e){return $("#urlField").attr("placeholder",e[0].url),e},bindListeners:function(){var e=this;return chrome.tabs.query({active:!0,currentWindow:!0},e.onTabQuery),$("#generateLink").on("click",e.generateLink.bind(e)),$("#link").on("click",this.selectAll),$("#copyButton").on("click",this.executeCopy),e.message.bindListeners(),e},resetGenerateLinkButton:function(){return $("#generateLink").removeClass("disabled"),$("#generateLink").html("Create Link"),$("#generateLink")}},"undefined"!=typeof module&&void 0!==module.exports&&(module.exports=WutController);
"use strict";var AlertController=function(){};AlertController.prototype={show:function(e){var n=this;return n.message.html(e),n.container.addClass("showing"),n},hide:function(){var e=this;return e.container.removeClass("showing"),e},bindListeners:function(){var e=this;e.container=$(".alertContainer"),e.message=e.container.find(".message:first"),$("#ok").on("click",e.hide.bind(e))}},"undefined"!=typeof module&&void 0!==module.exports&&(module.exports=AlertController);
"function"==typeof jQuery&&"function"==typeof WutController&&"function"==typeof AlertController&&!function(t,n,e){"use strict";t(document).ready(function(){var t=new n,o=new e(t);o.bindListeners()})}(jQuery,AlertController,WutController);