...
"use strict";var WutController=function(e){var t=this;t.message=e};WutController.prototype={pad:function(e){return 10>e?"0"+e:e},selectAll:function(){var e=$("#link");e.focus(),e.select()},executeCopy:function(){var e=document.createElement("textarea"),t=$("#link");document.body.appendChild(e),e.value=t.html(),e.focus(),e.select(),document.execCommand("Copy"),e.remove(),$(".linkHolder").addClass("copied"),setTimeout(function(){$(".linkHolder").removeClass("copied")},2e3)},generateLink:function(){var e=this,t=$("#urlField").val()||$("#urlField").attr("placeholder"),n=$("#activationDateField").val(),a=$("#deactivationDateField").val(),r=$("#generateLink");return r.hasClass("disabled")?!1:(r.addClass("disabled").html("Generating..."),$.ajax({url:"http://wut.link/",type:"POST",dataType:"json",data:{url:t,activateDate:n,deactivateDate:a},success:e.handleResponse.bind(e)}),void 0)},handleResponse:function(e){var t=this;e.errors?t.onGenerateLinkError(e.errors):t.onGenerateLinkSuccess(e),t.resetGenerateLinkButton()},onGenerateLinkError:function(e){var t,n=this,a=[];if("object"==typeof e)for(t in e)e.hasOwnProperty(t)&&(a=a.concat(e[t]));a.length&&void 0!==n.message&&(a.unshift("A link wasn't created because:<br>"),n.message.show(a.join("<br>")))},onGenerateLinkSuccess:function(e){var t=this,n=$("#generateLink");$("#link").html(e.proxyUrl),$(".linkHolder").addClass("loaded"),n.removeClass("disabled").html("Create Link"),$("#copyAsap").is(":checked")&&t.executeCopy()},bindListeners:function(){var e=this;chrome.tabs.query({active:!0,currentWindow:!0},function(e){$("#urlField").attr("placeholder",e[0].url)}),$("#generateLink").on("click",$.proxy(this.generateLink,this)),$("#link").on("click",this.selectAll),$("#copyButton").on("click",this.executeCopy),e.message.bindListeners()},resetGenerateLinkButton:function(){var e=$("#generateLink");e.removeClass("disabled").html("Create Link")}},"undefined"!=typeof module&&void 0!==module.exports&&(module.exports=WutController);
"use strict";var AlertController=function(){};AlertController.prototype={show:function(i){this.message.html(i),this.container.css("visibility","visible"),this.container.css("opacity",1)},hide:function(){this.container.css("visibility","hidden"),this.container.css("opacity",0)},bindListeners:function(){this.container=$(".alertContainer"),this.message=this.container.find(".message:first"),$("#ok").on("click",$.proxy(this.hide,this))}},"undefined"!=typeof module&&void 0!==module.exports&&(module.exports=AlertController);
